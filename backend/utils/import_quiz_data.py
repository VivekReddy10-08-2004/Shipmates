"""
Import quiz data from database CSV files into the main database.
...
DB_CONFIG = {
    ...
    'database': os.getenv('SB_DB_NAME', 'Shipmates')
}

# Paths to CSV files
DATABASE_DIR = Path(__file__).resolve().parent.parent.parent / "database" / "data" / "Clean_data"
QUESTIONS_CSV = DATABASE_DIR / "quiz_questions_clean.csv"
ANSWERS_CSV = DATABASE_DIR / "quiz_answers_clean.csv"
...
def import_quiz_data():
    """Import quiz data from staging CSVs to the main database."""
    
    print("\n" + "="*60)
    print("Quiz Data Import: CSV → Database")
    print("="*60)
    ...
    try:
        # Create quiz
        print("\n Creating quiz...")
        quiz_title = "SQL Basics (Imported)"
