...
RAW_CSV   = PROJECT_ROOT.parent / "Raw_data" / "course_resources.csv"
CLEAN_CSV = PROJECT_ROOT.parent / "Clean_data" / "course_resources_cleaned.csv"
SQL_OUT   = PROJECT_ROOT.parent.parent / "sql" / "load" / "import_clean_resources.sql"
